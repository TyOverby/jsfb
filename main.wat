  ...
  (func $module/quad
    ...
    (loop $y_loop
      ...
      (loop $x_loop
        ...
        (i32.ge_s (local.get $cx0) (i32.const 0))
        (i32.ge_s (local.get $cx1) (i32.const 0))
        (i32.ge_s (local.get $cx2) (i32.const 0))
        (i32.ge_s (local.get $cx3) (i32.const 0))
        ...
        (if 
          (i32.or 
              ...
              (i32.eq (local.get $y) (i32.const 95))))
          (then (nop)))
